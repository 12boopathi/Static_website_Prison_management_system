...
if(isset($_POST['btn']))
{
$qry=mysqli_query($connect,"select * from admin where uname='$uname' && password='$password'");
  ...
  <div id="contents">
   ...
   <form action="" method="post">
				    <table width="100%" border="0" align="center">
                      <tr>
                        <td colspan="2" rowspan="8" align="right"><img src="img/policelogin.jpg" width="300" height="300"></td>
